...
raw_data <- readMat("../data/raw/SC/HCP_cortical_DesikanAtlas_SC.mat")
...
# --- 3. Merge Everything ---
traits <- read.csv("../data/raw/traits/table1_hcp.csv")
...
raw_sc <- readMat("../data/raw/SC/HCP_cortical_DesikanAtlas_SC.mat")
...
df_traits <- read.csv("../data/raw/traits/table1_hcp.csv", stringsAsFactors=FALSE)
